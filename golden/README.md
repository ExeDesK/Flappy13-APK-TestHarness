# Canonical APK traces

These CSV files are deterministic state traces captured from the instrumented reference APK in the documented API 19 / x86 environment.
